...
//	static  Product[] shopping = new Product[5]; 
	static Product [] shopping =  { new Product ("Business Ritual Women's long sleeve top", 65.39, "Apparel", 4, 'L', "blue") ,
...
//					+ "To exit the shopping cart, enter any number other than 0 to 4");
		if( ! isShopOpen){
			System.out.println("Shop is not open at this time. Please come back later!");
		}
